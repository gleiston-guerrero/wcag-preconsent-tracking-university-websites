...
ENTRADA = sys.argv[1] if len(sys.argv) > 1 else "../../data/interim/cookies_126_sites.csv"
SALIDA  = sys.argv[2] if len(sys.argv) > 2 else "../../data/processed/qa_irregularities.csv"
