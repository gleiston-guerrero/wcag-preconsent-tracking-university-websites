...
def main():
    ...
    print("\n  Lo que ese bloque NO es: una estimacion de fiabilidad entre")
    print("  codificadores. El lado de la primera codificacion no sale de un")
    print("  segundo juicio humano, sino de sus ficheros de resolucion: 168 de las")
    print("  230 comparaciones vienen de las filas con codigo R03, la resolucion")
    print("  asistida por un sistema de IA generativa y revisada por el primer")
    print("  autor, y 62 de review_282_rows.csv, que no lleva codigo de evaluador.")
    print("  Ninguna de las 230 es un segundo juicio humano independiente del mismo")
    print("  elemento, asi que el coeficiente se reporta como acuerdo, nunca como")
    print("  fiabilidad entre codificadores.")
    print("\n  Para obtener esa fiabilidad haria falta que un codificador humano")
