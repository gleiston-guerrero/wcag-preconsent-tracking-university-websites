...
`act_round2/README_ES.md`, separado según qué mide cada cifra: una reproducibilidad entre
dos operadores para las reglas mecánicas; una estimación de fiabilidad entre codificadores
para las reglas de juicio solo del criterio 2.4.4, sobre 62 elementos de enlace de un
único sitio, demasiado imprecisa para establecer o refutar la fiabilidad; y, para 1.1.1,
una cifra de acuerdo que **no** es un coeficiente entre codificadores, porque el lado con
el que se compara es una resolución asistida y no una segunda codificación humana.
...
codificación. Un archivo es la excepción y lo declara en su propia sección: la hoja
`act_round2/review_282_rows.csv` se rellenó sin registrar quién la rellenó, y sus 81 filas
resueltas recibieron el código `R02` el 14 de septiembre de 2026 por atestación del
investigador principal y no en el momento de codificar. Ningún archivo de esta
